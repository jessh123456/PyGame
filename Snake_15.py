...
# Function to keep track of the highest score - writes to a file
def load_high_score():
    try:
...
def game_loop():
    ...
    snake_y = 340  # Centre point vertically is (620/2)-20 = 290
    ...
    while not quit_game:
        # Give the user the option to quit or play the game again when they die
        while game_over:
        ...
        # Handling response if use presses 'x' - giving them the option to
        ...
        # Using a sprite (instead of previous circle) to represent food
        ...
        # sets the speed at which each iteration of the game
        # loop runs in frames per second (fps). In this case it is set to 5fps
        clock.tick(speed)
